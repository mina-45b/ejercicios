...
const lista = document.getElementById('lista-v2');
...
lista.innerHTML = listaCompra.map(articulo => `<li><input type="checkbox" class='articulo' /><label class='mi-articulo'>${articulo}</label></li>`).join('');
